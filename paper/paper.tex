...
I am grateful to Evgeniya Korovina (Institute of Linguistics, Russian Academy of Sciences) for a correspondence in August 2026 that shaped this note: for naming the length-versus-composition distinction, for the question about catalogue size that became \S\ref{sec:sweep}--\ref{sec:syllabary}, for the observation about transliteration error, and for reading a draft.
